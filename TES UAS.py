...
# -------------------------------
# STEP 2: Convert Wide ke Long Format
# -------------------------------
# Drop kolom non-tahun
tahun_cols_prod = df_prod.columns[2:-1]  # Kolom tahun-tahun (skip 'Country' dan 'Coffee type', exclude 'Total_production')
...
tahun_cols_cons = df_cons.columns[2:-1]  # Sama, skip 'Country' dan 'Coffee type'
